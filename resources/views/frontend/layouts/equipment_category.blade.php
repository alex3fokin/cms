                            ...
                            <ul class="onepress-menu">
                                @if($menus->has('top menu'))
                                    ...
                                    @foreach($translated_menu_items as $menu_item)
                                        ...
                                        @endphp
                                        <li class="{{$url == $current_category_url ? 'current-menu-item' : ''}} menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-4 current_page_item menu-item-1274">
                                        ...
                                        @if($category_page->design_blocks)
                                            @foreach($category_page->design_blocks as $design_block)
                                                @php
                                                    ...
                                                    $data = $design_block->mapContent($blocks_contents);
                                                @endphp
                            ...
                            <div class="contact-block contact-block--footer">
                                <div class="contact-block__inner">
                                    <div class="contact-block__item contact-block__item--icon"><i
                                                ...
                                                class="contact-block__text">{!! $general_info['Address'] !!}</span>
                                    </div>
                                    <div class="contact-block__item contact-block__item--icon"><i
                                    ...
                                    <div class="contact-block__item contact-block__item--icon"><i
                                                ...
                                                class="contact-block__text"><a
                                                    href="mailto:{{$general_info['Email']}}">{{$general_info['Email']}}</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
