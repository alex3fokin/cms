<!DOCTYPE html>
<!-- saved from url=(0048)http://themes-pixeden.com/demos/glazzed/404.html -->
<html lang="en">
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/backend/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="/css/backend/main.min.css">

    <!-- Pixeden Icon Fonts -->
    <link rel="stylesheet" type="text/css" href="/css/backend/pe-icon-7-filled.css">
    <link rel="stylesheet" type="text/css" href="/css/backend/pe-icon-7-stroke.css">
</head>
<body>
...
<header class="top-bar">
    ...
    <ul class="profile">
        <li>
            <a href="/index.html#" class="btn-circle no-circle">
                <i class="pe-7f-back"></i>
            </a>
        </li>
        <li>
            <a href="/index.html#" onclick="return false;" class="btn-circle btn-sm">
        ...
        <li>
            <a href="/index.html#" onclick="return false;" class="btn-circle btn-sm active">
    ...
    <div class="main-brand">
        <div class="main-brand__container">
            <div class="main-logo"><img src="/images/logo.png"></div>
    ...
    <aside class="sidebar">
        ...
        <div class="user-info">
            <figure class="rounded-image profile__img">
                <img class="media-object" src="/images/profile.jpg" alt="user">
            </figure>
        ...
        <ul class="main-nav">
            ...
            <li class="main-nav--collapsible">
                <a class="main-nav__link" href="/index.html#" onclick="return false;">
        ...
        <header class="main-header">
            <div class="main-header__nav">
                ...
                <ul class="main-header__breadcrumb">
                    ...
                    <li><a href="/index.html#" onclick="return false;">Dashboard</a></li>
                    <li class="active"><a href="/index.html#" onclick="return false;">Sample Pages</a></li>
                </ul>
            </div>
        ...
        <div data-tab-radio="tab-radio" class="tab-radio-content row" id="today" style="display: block;">
            ...
            <div class="main-stats__stat col-md-3 col-sm-3 col-xs-4">
                <div class="stat-circle">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92">
                        <circle style="opacity:0.16;fill:none;stroke:#000000;stroke-width:2;stroke-miterlimit:10;" cx="46" cy="46" r="45"></circle>
                        <path style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-miterlimit:10;" d="M84.839,68.718C88.749,62.049,91,54.289,91,46C91,21.147,70.853,1,46,1"></path>
                    </svg>
                </div> <!-- /stat-circle -->
            ...
            <div class="main-stats__stat col-md-3 col-sm-3 col-xs-4">
                <div class="stat-circle">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92">
                        <circle style="opacity:0.16;fill:none;stroke:#000000;stroke-width:2;stroke-miterlimit:10;" cx="46" cy="46" r="45"></circle>
                        <path style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-miterlimit:10;" d="M6.185,66.968C13.725,81.256,28.721,91,46,91c24.853,0,45-20.147,45-45C91,21.147,70.853,1,46,1"></path>
                    </svg>
                </div> <!-- /stat-circle -->
            ...
            <div class="main-stats__stat col-md-3 col-sm-3 col-xs-4">
                <div class="stat-circle">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92 92">
                        <circle style="opacity:0.16;fill:none;stroke:#000000;stroke-width:2;stroke-miterlimit:10;" cx="46" cy="46" r="45"></circle>
                        <path style="fill:none;stroke:#FFFFFF;stroke-width:2;stroke-miterlimit:10;" d="M91,46C91,21.147,70.853,1,46,1"></path>
                    </svg>
                </div> <!-- /stat-circle -->
                ...
                <article class="widget">
                    <header class="widget__header">
                        ...
                        <div class="widget__config">
                            <a href="/index.html#"><i class="pe-7f-refresh"></i></a>
                            <a href="/index.html#"><i class="pe-7s-close"></i></a>
                        </div>
                    </header>

                    <div class="widget__content filled">
                        <p class="graph-number"><span>6,184</span> Visits</p>
                        <div id="chartdiv" style="width: 100%; height: 362px; overflow: hidden; text-align: left;"></div>
            ...
            <div class="col-md-6">
                <article class="widget">
                    <header class="widget__header">
                        ...
                        <div class="widget__config">
                            <a href="/index.html#"><i class="pe-7f-refresh"></i></a>
                            <a href="/index.html#" style="line-height: 68px;"><i class="pe-7g-arrow2-down"></i></a>
                        </div>
                    </header>
                    ...
                    <div class="widget__content">
                        <div class="tabs">
                            ...
                            <div class="tabs__content" style="height: 600px;">

                                <div class="tabs__content--1">

                                    <div class="media message">
                                        <figure class="pull-left rounded-image message__img">
                                            <img class="media-object" src="/images/user1.jpg" alt="user">
                                        </figure>
                                        <div class="media-body">
                                            ...
                                            <div class="message__controls--cont">
                                                <ul class="message__controls">
                                                    <li><a href="/index.html#" onclick="return false;"><i class="pe-7f-back pe-rotate-180"></i> <span>Reply</span></a></li>
                                                    <li><a href="/index.html#" class="set_fav" onclick="return false;"><i class="pe-7f-star"></i> <span>Favorite</span></a></li>
                                                    <li><a href="/index.html#" onclick="return false;"><i class="pe-7f-trash"></i> <span>Delete</span></a></li>
                                                    <li><a href="/index.html#" class="close_cntrl" onclick="return false;"><i class="pe-7g-arrow2-up"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div> <!-- /message -->
                                    ...
                                    <div class="media message">
                                        <figure class="pull-left rounded-image message__img">
                                            <img class="media-object" src="/images/user3.jpg" alt="user">
                                        </figure>
                                        <div class="media-body">
                    ...
                    <div class="widget__content">
                        ...
                        <div class="members__container">
                            ...
                            <div class="media message checked">
                                <figure class="pull-left rounded-image message__img">
                                    <img class="media-object" src="/images/user4.jpg" alt="user">
                                </figure>
                                <div class="media-body">
            ...
            <div class="col-md-8">
                <article class="widget">
                    <header class="widget__header one-btn">
                        ...
                        <div class="widget__config">
                            <a href="/index.html#"><i class="pe-7s-plus"></i></a>
                        </div>
                    </header>
                    ...
                    <div class="widget__content table-responsive">
                        ...
                        <table class="table table-striped media-table">
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <figure class="pull-left post__img">
                                            <img class="media-object" src="/images/post1.jpg" alt="user">
                                        </figure>
                                ...
                                <td>
                                    <a href="/index.html#" onclick="return false;" class="post__del"><i class="pe-7f-close"></i></a>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <figure class="pull-left post__img">
                                            <img class="media-object" src="/images/post2.jpg" alt="user">
                                        </figure>
                                        <div class="media-body post_desc">
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <figure class="pull-left post__img">
                                            <img class="media-object" src="/images/post3.jpg" alt="user">
                                        </figure>
                                        <div class="media-body post_desc">
                    ...
                    <div class="widget__content filled widget-ui">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="slider range-min active ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" aria-disabled="false">
                                    <span class="num-min">4k</span>
                                    <span class="num-max">10k</span>
                                    <a class="ui-slider-handle ui-state-default ui-corner-all" href="/index.html#" style="left: 28.5714%;"></a><div class="ui-slider-range ui-widget-header ui-corner-all ui-slider-range-min" style="width: 28.5714%;"></div></div>
                                <div class="slider range green ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" aria-disabled="false">
                                    <span class="num-min">32k</span>
                                    <span class="num-max">61k</span>
                                    <a class="ui-slider-handle ui-state-default ui-corner-all" href="/index.html#" style="left: 32%;"></a><div class="ui-slider-range ui-widget-header ui-corner-all" style="left: 32%; width: 29%;"></div><a class="ui-slider-handle ui-state-default ui-corner-all" href="/index.html#" style="left: 61%;"></a></div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-7 text-center btn__showcase">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/index.html#">Image Gallery</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/index.html#">Latest Features</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="/index.html#">Contact Us</a></li>
                                    </ul>
                                </div>
                                <div class="dropdown">
...
<script type="text/javascript" src="/js/backend/amcharts.js"></script>
<script type="text/javascript" src="/js/backend/serial.js"></script>
<script type="text/javascript" src="/js/backend/pie.js"></script>
<script type="text/javascript" src="/js/backend/chart.js"></script>
