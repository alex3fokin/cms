...
<head>
    ...
    <link rel="stylesheet" id="onepress-bootstrap-css" href="/css/frontend/bootstrap.min.css" type="text/css" media="all">
...
<div id="page" class="hfeed site">
    ...
    <div id="header-section" class="h-on-top no-transparent">
        <div class="followWrap" style="height: 157px;">
                                ...
                                @if($menus->has('top menu'))
                                    ...
                                    @foreach($menus['top menu']->translatedMenuItems($locale_id) as $menu_item)
                                        @php
                                            if($menu_item->page) {
                                                $entity = 'page';
                                            } elseif($menu_item->category) {
                                                $entity = 'category';
                                            }
                                            $url = $entity ? $menu_item->$entity->url : '#';
                                        @endphp
                                        <li class="{{$url == $current_page_url ? 'current-menu-item' : ''}} menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-4 current_page_item menu-item-1274">
            ...
            <section id="news" class="section-news section-padding onepage-section">
                <div class="container">
                    <div class="section-title-area">
                        <h5 class="section-subtitle">только интересное</h5>
                        <h2 class="section-title">Новости</h2></div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="footer-social">
                            ...
                            <div class="footer-social-icons"><a target="_blank"
                                                                href="{{$general_info['Facebook']}}"
                                                                title="Facebook"><i
                                            class="fa fa fa-facebook-square"></i></a><a target="_blank"
                                                                                        href="{{$general_info['Youtube']}}"
                                                                                        title="youtube"><i
                                            class="fa fa fa-youtube-square"></i></a><a target="_blank"
                                                                                       href="{{$general_info['Vk']}}"
                                                                                       title="vk"><i
                                            class="fa fa fa-vk"></i></a><a target="_blank"
                                                                           href="{{$general_info['Google plus']}}"
                                                                           title="google"><i
                                            class="fa fa fa-google-plus-official"></i></a></div>
                        </div>
                    </div>
                            ...
                            <div class="contact-block contact-block--footer">
                                <div class="contact-block__inner">
                                    <div class="contact-block__item contact-block__item--icon"><i
                                                ...
                                                class="contact-block__text">{!! $general_info['Address'] !!}</span></div>
                                    <div class="contact-block__item contact-block__item--icon"><i
                                    ...
                                    <div class="contact-block__item contact-block__item--icon"><i
                                                ...
                                                class="contact-block__text"><a href="mailto:{{$general_info['Email']}}">{{$general_info['Email']}}</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
